...
function getCardId(value) {const names = 'A2345678910JQK';const suits = '♣♦♥♠';
  if (value[0] === 'J' || value[0] === 'Q' || value[0] === 'K') {
    return (suits.indexOf(value.slice(-1)) * 13 + names.indexOf(value[0]) - 1);
  }else return (suits.indexOf(value.slice(-1)) * 13 + names.indexOf(value[0]));
}
